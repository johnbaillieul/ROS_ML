...
class Controller(Node):
    ...
    def __init__(self):
        ...
        # Tau Data Subscriber
        self.tau_values = self.create_subscription( TauComputation, "tau_values_combo", self.callback)
        ...
        self.steering_signal = self.create_publisher(Twist, self.robot_publisher, queue_size=10)
